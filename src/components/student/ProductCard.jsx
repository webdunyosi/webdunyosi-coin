...
const ProductCard = ({ product, onAddToCart, disabled = false }) => {
  return (
    <div className={`bg-linear-to-br from-zinc-800/50 to-zinc-900/50 backdrop-blur border border-green-500/20 p-4 md:p-5 rounded-xl shadow-lg transition-all duration-300 ${disabled ? "opacity-40 blur-sm" : "hover:border-green-500/50 hover:shadow-green-500/20 hover:scale-105"} group`}>
      {/* Image */}
